...
User can change the model (torus or can),  number of lights,
ambient component (R,G,B),  specular focus and contribution and
...
ControlP5 cp5;
Textlabel lights, ambient, specular, diffuse;
float R, G, B;
...
void setup() {
  ...
  //No of lights
  lights = cp5.addTextlabel("Lights")
    .setText("No of lights:")
    .setPosition(60, 340)
    .setColor(255)
    .setFont(createFont("Helvetica", 15))
    ;

  cp5.addSlider("noOfLights")
    .setLabel("")
    .setColorLabel(255)
    .setPosition(60, 360)
    .setSize(150,20)
  ...
  //Ambient
  ambient = cp5.addTextlabel("Ambient Component")
    .setText("Ambient Component:")
    .setPosition(60, 390)
    .setColor(255)
    .setFont(createFont("Helvetica", 15))
    ;
  ...
  cp5.addSlider("R")
    ...
    .setColorForeground(color(225, 0, 0))
  ...
  cp5.addSlider("B")
    ...
    .setColorForeground(color(0, 0, 225))
...
void draw() {
  ...
  if (noOfLights >=2) {
    pointLight(0, 255, 0, (1.5* width)*(time2/5000)-250, -500, 200);
    if (noOfLights == 3) {
      pointLight(0, 255, 0, 0, (1.5* height)*(time2/5000)-500, 200);
    }
  }
  pushMatrix();
  translate(0, -250);
